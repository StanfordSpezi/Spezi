...
public enum ModuleBuilder {
    ...
    public static func buildBlock(_ components: [any Module]...) -> [any Module] {
        components.flatMap { $0 }
    }
    
    /// Enables support for `if` statements that do not have an `else`.
    public static func buildOptional(_ component: [any Module]?) -> [any Module] {
    ...
    public static func buildArray(_ components: [[any Module]]) -> [any Module] {
        components.flatMap { $0 }
    }
    ...
    public static func buildLimitedAvailability(_ component: [any Module]) -> [any Module] {
        component
    }
    ...
    public static func buildFinalResult(_ component: [any Module]) -> ModuleCollection {
        ModuleCollection(elements: component)
    }
}
