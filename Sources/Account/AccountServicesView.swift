...
public struct AccountServicesView<Header: View>: View {
    ...
    public init(button: @escaping (any AccountService) -> AnyView) where Header == EmptyView {
        self.header = EmptyView()
        self.button = button
    }
    
    public init(header: Header, button: @escaping (any AccountService) -> AnyView) {
        self.header = header
        self.button = button
    }
}
