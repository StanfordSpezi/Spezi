...
extension Localization {
    /// The ``Localization/SignUp-swift.struct`` type provides default values for all localization properties that are loaded from the ``Account`` module in all supported localizations.
    ///
