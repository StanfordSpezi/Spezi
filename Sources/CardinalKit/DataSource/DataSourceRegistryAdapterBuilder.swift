...
actor TwoDataSourceRegistryAdapterChain<InputType: Identifiable, IntermediateType: Identifiable, OutputType: Identifiable>: Actor, DataSourceRegistryAdapter {
...
actor ThreeDataSourceRegistryAdapterChain<
